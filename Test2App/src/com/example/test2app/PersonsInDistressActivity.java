...
public class PersonsInDistressActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_persons_in_distress);
		
		//creates textView:"ins" that corresponds to textView:"PersonsInDistressTextView" in file:"activity_persons_in_distress.xml"
		TextView ins = (TextView)findViewById(R.id.PersonsInDistressTextView);
		//sets the text of textview to string found in strings file
		ins.setText(Html.fromHtml(getString(R.string.persons_in_distress_text)));
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.persons_in_distress, menu);
		return true;
	}
}
