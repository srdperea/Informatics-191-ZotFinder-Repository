...
public class FireActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//creates textView:"ins" that corresponds to textView:"FireTextView" in file:"activity_fire.xml"
		TextView ins = (TextView)findViewById(R.id.FireTextView);
		//sets the text of textview to string found in strings file
		ins.setText(Html.fromHtml(getString(R.string.fire_text)));
	}
